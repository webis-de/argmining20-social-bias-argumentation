...
def main():
    ...
    file_basename = f"iac_posts{args.filename_postfix}--glove-format"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "-i",
        required=True,
        help="The path to the IAC data file (combined or a single portal).",
        metavar="IAC_DATA")
    parser.add_argument(
        "--output",
        "-o",
    ...
    parser.add_argument(
        ...
        "-p",
        default="",
        help="A string that is added to the output filename.",
        metavar="FILENAME_POSTFIX")
    parser.add_argument(
        "--splits",
        "-s",
        required=True,
